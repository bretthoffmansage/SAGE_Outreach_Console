...
Completion evidence: reviewed catch-all route dispatch for dashboard, campaigns, reviews, libraries, intelligence, operations, and settings; verified manual/missing-credential and no-auto-send messaging exists in route components.
...
Completion evidence: verified global skip link, focus-ring styling, route headings, and Bari/Blue review summaries emphasize non-technical decision/copy workflows.
...
Completion evidence: `.env.example` exists, README contains route map, lint/build commands, missing-key demo/manual mode, and live setup posture.
